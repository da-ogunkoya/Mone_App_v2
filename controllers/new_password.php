                    ...
                    <div class="col-md-7 col-md-offset-3 well well-md">
                            <form  ng-submit="submit()" name="log" >
                              ...
                              <div class="form-group">
                                    <input type="password" class="form-control btn-block" name="password" value="" placeholder="Password " ng-model="password" id="password" required>
                              </div>

                               <div class="form-group">
                                    <input type="password" class="form-control btn-block" name="cpassword" value="" placeholder="Confirm Password" ng-model="cpassword" id="cpassword" required>
                              </div>
