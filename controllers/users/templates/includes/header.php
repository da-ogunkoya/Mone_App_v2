  ...
  <div class="navbar-header">
    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-responsive-collapse">
      ...
      <span class="icon-bar"></span>
		...
		<div id="logo_head">
			<img src="img_logo.php" width="40px" height="40px">
	...
	<?php if(isLoggedIn()) : ?>	  
			...
			<div class="panel-body">
					...
					<div class="panel-border">
						<section id="quickinfo" class="well well-lg">
							...
							<?php if(getUser()['type']=='agent'): ?><span class="pull-right"> Bal:&#163; <?php 
							if(binfo()['ecredit']==1){ echo number_format((agentCredit()),2);} else { echo number_format((agentBal()),2);} ?> </span>
							<?php  endif;?>
		...
		<?php endif; ?>
            ...
            <div class="list-group">
				  ...
				  <a href="sendersReceivers.php" class="list-group-item"><i class="glyphicon glyphicon-tags"></i> New Receiver</a>
				  <?php endif; ?>
				  <?php if(getUser()['type']=='customer'): ?>
				  <a href="cReceiver.php" class="list-group-item"><i class="glyphicon glyphicon-plus"></i> New Receiver</a>
				  <?php endif; ?>
				  <?php if(getUser()['type']=='agent'): ?>
				  <a href="sendersReceivers.php" class="list-group-item"><i class="glyphicon glyphicon-user"></i> Senders List</a>
				  <?php endif; ?>
