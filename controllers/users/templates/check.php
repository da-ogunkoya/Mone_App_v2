...
<!----Receiver Ajax/jquery----->  
    ...
    success: function (data) {
		...
		$("#rBank")
    .replaceWith('<select id="rBank" name="rBank" class="form-control">' +
         '</select>');
	document.getElementById("rBank").innerHTML=data['rBank'];
					...
					<div class="well">
						<div class="row">
							...
							<div class="col-md-4 col-md-offset-1">
								...
								<input name="rLName" id="rLName" type="text" class="form-control" readonly  placeholder="Sender Last Name" 
						...
						<div class="row">
							<div class="col-md-4 col-md-offset-1">
								...
								value="<?php if(isset($rPhone)){ echo $rPhone; } ?>" placeholder="Receivers Phone No">
								</div>
							</div>
							<div class="col-md-4 col-md-offset-1">
								<div class="form-group form-group-sm">
						...
						<div class="row">
							<div class="col-md-4 col-md-offset-1">
								...
								<input name="rBank" id="rBank" type="text" readonly class="form-control" 
									value="<?php if(isset($rBank)){ echo $rBank; } ?>" placeholder="Receivers Bank">
								</div>
							</div>
							<div class="col-md-4 col-md-offset-1">
								<div class="form-group form-group-sm">
								...
								value="<?php if(isset($rActno)){ echo $rActno; } ?>" placeholder="Receivers Account No">
								</div>
							</div>
					</div>
				</div>
