...
<!---Sender Info--->				
				...
				<div class="row">
					<div class="col-md-4">
						<div class="form-group form-group-sm">
						<label>Address</label>
							<input class="form-control" type="text" name="address" value="<?php if(isset($address)){ echo $address;} else { echo strtoupper($result->address);} ?>" readonly>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-2">
						...
						<label>Post Code</label>
							<input class="form-control" type="text" name="postcode" value="<?php if(isset($postcode)){ echo $postcode;} else { echo strtoupper($result->postcode);} ?>" readonly>
						</div>
					</div>
					...
					<div class="col-md-2">
						<div class="form-group form-group-sm">
						<label>Country</label>
							<input class="form-control" type="text" name="country" value="<?php if(isset($country)){ echo $country;} else { echo strtoupper($result->country);} ?>" readonly>
						</div>
					</div>
