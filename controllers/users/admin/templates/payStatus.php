			...
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
						<div class="input-group input-group-md">
							...
							<input type="text" name="no" value="<?php echo $count;?>" class="form-control" >
						</div>
					</div>
				</div>
	<br/>
			...
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
						<div class="input-group input-group-md">
							...
							<textarea name="no" rows="2"  class="form-control" ><?php foreach($receipt as $receipt){ echo $receipt.", ";}?></textarea>
						</div>
					</div>
				</div>
<!--Type transaction--->				
