...
<?php include('includes/header.php'); ?>
 ...
 <div class="panel panel-primary">
		...
		<div class="panel-heading">
				<h4 class="well well-md">Edit Profile</h4>
		</div>
			...
			<div class="container">
				...
				<div class="row">
						...
						<div class="col-md-2 col-md-offset-1">
							<img src="<?php echo BASE_URI; ?>img/<?php  echo getUser()['type'];?>/senders/id/<?php  echo $result->proofid_name;?>" width="50" height="50" alt="..." class="img-thumbnail">
						</div>
				...
				<div class="row">
						...
						<div class="col-md-2 col-md-offset-1">
							<img src="<?php echo BASE_URI; ?>img/<?php  echo getUser()['type'];?>/senders/address/<?php  echo $result->proofad_name;?>" width="50" height="50" alt="..." class="img-thumbnail">
						</div>
