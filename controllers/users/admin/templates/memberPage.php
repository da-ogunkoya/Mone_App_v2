			...
			<div class="row">
				<div class="col-md-4">
					<div class="memberProfile">
						...
						<a href="payAgentCom.php?Id=<?php echo $result->id; ?>" class="btn btn-primary btn-lg">Pay Commission</a>
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="memberProfile">
						...
						<a href="setCommission.php?Id=<?php echo $result->id; ?>"  class="btn btn-info btn-lg">Modify Commission</a>
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="memberProfile">
						...
						<a href="splitCom.php?Id=<?php echo $result->id; ?>& type=<?php echo $type;?>" class="btn btn-danger btn-lg ">View</a>
					</div>
				</div>
			</div>
		</div>
...
<!--General-Delete/status/Edit--->
		...
		<div class="well">
			<div class="row">
				<div class="col-md-4">
					<div class="memberProfile">
						<h7><h7>Status:<?php  echo ($result->level==3 && $result->active==1) ?"Manager":($result->active==1?"Active":($result->active==-1?"Limited Operation":"Suspended"));?></h7></h7>
						<div class="image">
							<strong>Change Status </strong>:<i class="fa fa-power-off fa-2x" aria-hidden="true"></i>
						</div>
						<a href="status.php?Id=<?php echo $result->id; ?>"  class="btn btn-primary btn-lg">View</a>
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="memberProfile">
						...
						<a href="deleteMember.php?Id=<?php echo $result->id; ?>"" class="btn btn-info btn-lg">View</a>
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="memberProfile">
						...
						<a href="mModify.php?Id=<?php echo $result->id; ?> & type=<?php echo $type; ?>" class="btn btn-danger btn-lg ">View</a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="memberProfile">
						...
						<a href="activites.php?Id=<?php echo $result->id; ?> & type=<?php echo $type; ?>" class="btn btn-primary btn-lg">View</a>
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="memberProfile">
						...
						<div class="image">
							<strong>Monthly Turn-Over</strong>
						</div>
						<a href="turnOver.php?Id=<?php echo $result->id; ?> & type=<?php echo $type; ?>" class="btn btn-info btn-lg">View</a>
					</div>
				</div>
				
				<div class="col-md-4">
					<div class="memberProfile">
						<h7><i class="fa fa-money fa-2x" aria-hidden="true"></i></h7>
						<div class="image">
							<strong>Add Credit (<?php echo $result->credit; ?>)</strong>
						</div>
						<a href="addCredit.php?Id=<?php echo $result->id; ?> & type=<?php echo $type; ?>" class="btn btn-danger btn-lg ">Add</a>
					</div>
				</div>
			</div>
		</div>
