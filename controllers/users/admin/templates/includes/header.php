				  ...
				  <div class="navbar-collapse collapse navbar-responsive-collapse">
					<ul class="nav navbar-nav">
					  <li><a href="index.php">Home</a></li>
						...
						<li class="dropdown">
							<?php if((binfo()['size']=='1')|| (binfo()['size']=='2') || (binfo()['size']=='3') || (binfo()['size']=='4') ): ?>
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">Customers <b class="caret"></b></a>
									<ul class="dropdown-menu">
										<li><a href=""members.php?type=c">Menu</a></li>
										<li><a href="previousTransaction.php?type=c">Transactions</a></li>
					...
					<li class="dropdown">
							...
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">My Staff <b class="caret"></b></a>
									<ul class="dropdown-menu">
										<li><a href="members.php?type=a">Agent Menu</a></li>
										<li><a href="previousTransaction.php?type=a">Transactions</a></li>
					...
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">Transactions <b class="caret"></b></a>
						...
						<?php if((binfo()['size']=='2')|| (binfo()['size']=='3') || (binfo()['size']=='4') ): ?>
							<li><a href="outstanding.php">Outstanding Balance</a></li>
						<?php endif; ?>
					...
					<ul class="nav navbar-nav navbar-right">
					  <li class="dropdown">
						...
						<ul class="dropdown-menu">
						  ...
						  <li><a href="transBank.php">Bank Setup</a></li>
					  ...
					  <li class="dropdown">
						...
						<ul class="dropdown-menu">
						  ...
						  <li><a href="outstanding.php">Balance Remittance</a></li>
...
<!--col-md-3-->
		 <div class="col-md-3">
				<?php if(isLoggedIn()) : ?>	  
				  ...
				  <?php if(binfo()['size']=='1'){ echo "bak1";} 
						if(binfo()['size']=='2'){ echo "bak2";}
						if(binfo()['size']=='3'){ echo "bak3";}
						if(binfo()['size']=='4'){ echo "bak4";}
						...
						<div class="row">	
							<div class="col-md-12">
								<div class="pull-left image">
										<img src="<?php echo BASE_URI; ?>img/agent/photo/<?php echo getUser()['photo']; ?>" width="50" height="50" alt="..." class="img-thumbnail">
								</div>
							</div>
						</div>
						<div class="row">	
							<div class="col-md-12">
								<div  class="user">
								  <h3> Welcome <strong style="color:#000000;"> <?php echo getUser()['fname']; ?>!</strong></h3> 
								</div >
							</div>
						</div>
							...
							<div class="well well-md">
								<h4 class="text-center"> &pound; 1= &#8358 </h4>
				...
				<?php endif; ?>
					...
					<div class="list-item">
					   ...
					   <?php if((binfo()['size']=='2')|| (binfo()['size']=='3') || (binfo()['size']=='4') ): ?>
						<a href="members.php?type=a" class="list-group-item"><i class="glyphicon glyphicon-user"></i> Agent</a>
					  <?php endif; ?>
					  
					   <?php if((binfo()['size']=='1')|| (binfo()['size']=='2') || (binfo()['size']=='3') || (binfo()['size']=='4') ): ?>
						<a href="members.php?type=c" class="list-group-item"><i class="glyphicon glyphicon-user"></i> Customers</a>
					  <?php endif; ?>
					   ...
					   <?php if( (binfo()['size']=='3') || (binfo()['size']=='4') ): ?>
						<a href="outstanding.php" class="list-group-item"><i class="glyphicon glyphicon-user"></i> Outstanding Balance</a>
					  <?php endif; ?>
					  
					  
					   <?php if( (binfo()['size']=='4') ): ?>
						<a href="n2uk/login" class="list-group-item"><i class="glyphicon glyphicon-user"></i> Nigeria To UK App</a>
					  <?php endif; ?>
					  <a href="help.php" class="list-group-item"><i class="glyphicon glyphicon-record"></i> Help</a>
					   <a href="mPassword.php" class="list-group-item"><i class="glyphicon glyphicon-record"></i> Modify Password</a>
					</div>  
				  </div>
			</div>
