<?php require "config/init.php";
		$template=new Template('templates/check.php');
	...
	//for customer account
				...
				$receivers=$_POST['receivers']=="Setup Receiver"?trim($_POST['rFName'])." ".trim($_POST['rLName']):$_POST['receivers'];
				$amount=$_POST['amount'];
				...
				$required=array('senders','receivers','amount','rFName','rLName','tOption','rActno','rBank');
